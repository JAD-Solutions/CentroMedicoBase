...
Public Class Factura
    ...
    'atributos
    Dim _numero_fac As Integer
    Dim _cliente_fac As Cliente
    Dim _detallefactura_fac As List(Of DetalleFactura)
    ...
    End Sub
    Public Sub New(ByVal numero_fac As Integer, ByVal cliente_fac As Cliente, ByVal detallefactura_fac As List(Of DetalleFactura), ByVal total_fac As Double, ByVal fecha_fac As Date)
        Me._numero_fac = numero_fac
    ...
    End Sub
    'propiedades
    Public Property Numero_fac As Integer
        Get
            Return Me._numero_fac
        End Get
        Set(value As Integer)
            Me._numero_fac = value
            Me.cambioPropiedad("Numero_fac")
        End Set
    End Property
    Public Property Cliente_fac As Cliente
        ...
        End Set
    End Property
    Public Property Detallefactura_fac As List(Of DetalleFactura)
        Get
            Return Me._detallefactura_fac
        End Get
        Set(value As List(Of DetalleFactura))
